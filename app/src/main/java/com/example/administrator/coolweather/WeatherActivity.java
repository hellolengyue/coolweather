...
import com.example.administrator.coolweather.gson.Forecase;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    private void requestWeather(final String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=b768d61c31a6418c92fa0d3fc7e9c38b";
    ...
    private void showWeatherInfo(Weather weather) {
        ...
        for (Forecase forecast :
                weather.forecaseList) {
            View view = LayoutInflater.from(this).inflate(R.layout.forcecast_item, forecast_layout, false);
